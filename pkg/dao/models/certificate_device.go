...
type CertificateDevice struct {
	...
	BizExt        datatype.CertificateDeviceBizExt `boil:"biz_ext" json:"biz_ext" toml:"biz_ext" yaml:"biz_ext"`
	// 写入时间
...
var CertificateDeviceTableColumns = struct {
	ID            string
	DeviceID      string
	CertificateID string
	BizExt        string
	...
	ID:            "certificate_device.id",
	DeviceID:      "certificate_device.device_id",
	CertificateID: "certificate_device.certificate_id",
	BizExt:        "certificate_device.biz_ext",
	CreatedAt:     "certificate_device.created_at",
	UpdatedAt:     "certificate_device.updated_at",
}

// Generated where

type whereHelperdatatype_CertificateDeviceBizExt struct{ field string }

func (w whereHelperdatatype_CertificateDeviceBizExt) EQ(x datatype.CertificateDeviceBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperdatatype_CertificateDeviceBizExt) NEQ(x datatype.CertificateDeviceBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperdatatype_CertificateDeviceBizExt) LT(x datatype.CertificateDeviceBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperdatatype_CertificateDeviceBizExt) LTE(x datatype.CertificateDeviceBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperdatatype_CertificateDeviceBizExt) GT(x datatype.CertificateDeviceBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperdatatype_CertificateDeviceBizExt) GTE(x datatype.CertificateDeviceBizExt) qm.QueryMod {
...
var CertificateDeviceWhere = struct {
	...
	BizExt        whereHelperdatatype_CertificateDeviceBizExt
	...
	BizExt:        whereHelperdatatype_CertificateDeviceBizExt{field: "`certificate_device`.`biz_ext`"},
...
var (
	certificateDeviceAllColumns            = []string{"id", "device_id", "certificate_id", "biz_ext", "created_at", "updated_at"}
	certificateDeviceColumnsWithoutDefault = []string{"device_id", "certificate_id", "biz_ext"}
	certificateDeviceColumnsWithDefault    = []string{"id", "created_at", "updated_at"}
	certificateDevicePrimaryKeyColumns     = []string{"id"}
	certificateDeviceGeneratedColumns      = []string{}
)
...
func CertificateDevices(mods ...qm.QueryMod) certificateDeviceQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`certificate_device`.*"})
	}

	return certificateDeviceQuery{q}
}
...
// Exists checks if the CertificateDevice row exists.
func (o *CertificateDevice) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return CertificateDeviceExists(ctx, exec, o.ID)
}
