...
var IpaVersionTableColumns = struct {
	ID          string
	IpaID       string
	Version     string
	IpaType     string
	...
	ID:          "ipa_version.id",
	IpaID:       "ipa_version.ipa_id",
	Version:     "ipa_version.version",
	IpaType:     "ipa_version.ipa_type",
	TokenPath:   "ipa_version.token_path",
	BizExt:      "ipa_version.biz_ext",
	IsTemporary: "ipa_version.is_temporary",
	CreatedAt:   "ipa_version.created_at",
	UpdatedAt:   "ipa_version.updated_at",
}
...
var (
	...
	ipaVersionGeneratedColumns      = []string{}
)
...
func IpaVersions(mods ...qm.QueryMod) ipaVersionQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`ipa_version`.*"})
	}

	return ipaVersionQuery{q}
}
...
// Exists checks if the IpaVersion row exists.
func (o *IpaVersion) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return IpaVersionExists(ctx, exec, o.ID)
}
