...
type whereHelperdatatype_FileBizExt struct{ field string }

func (w whereHelperdatatype_FileBizExt) EQ(x datatype.FileBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperdatatype_FileBizExt) NEQ(x datatype.FileBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperdatatype_FileBizExt) LT(x datatype.FileBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperdatatype_FileBizExt) LTE(x datatype.FileBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperdatatype_FileBizExt) GT(x datatype.FileBizExt) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperdatatype_FileBizExt) GTE(x datatype.FileBizExt) qm.QueryMod {
