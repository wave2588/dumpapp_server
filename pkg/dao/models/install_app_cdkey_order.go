...
var InstallAppCdkeyOrderTableColumns = struct {
	ID        string
	Contact   string
	Status    string
	Number    string
	...
	ID:        "install_app_cdkey_order.id",
	Contact:   "install_app_cdkey_order.contact",
	Status:    "install_app_cdkey_order.status",
	Number:    "install_app_cdkey_order.number",
	Amount:    "install_app_cdkey_order.amount",
	BizExt:    "install_app_cdkey_order.biz_ext",
	CreatedAt: "install_app_cdkey_order.created_at",
	UpdatedAt: "install_app_cdkey_order.updated_at",
}
...
var (
	...
	installAppCdkeyOrderGeneratedColumns      = []string{}
)
...
func InstallAppCdkeyOrders(mods ...qm.QueryMod) installAppCdkeyOrderQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`install_app_cdkey_order`.*"})
	}

	return installAppCdkeyOrderQuery{q}
}
...
// Exists checks if the InstallAppCdkeyOrder row exists.
func (o *InstallAppCdkeyOrder) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return InstallAppCdkeyOrderExists(ctx, exec, o.ID)
}
