...
var MemberInviteTableColumns = struct {
	ID        string
	InviterID string
	InviteeID string
	CreatedAt string
	...
	ID:        "member_invite.id",
	InviterID: "member_invite.inviter_id",
	InviteeID: "member_invite.invitee_id",
	CreatedAt: "member_invite.created_at",
	UpdatedAt: "member_invite.updated_at",
}
...
var (
	...
	memberInviteGeneratedColumns      = []string{}
)
...
func MemberInvites(mods ...qm.QueryMod) memberInviteQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`member_invite`.*"})
	}

	return memberInviteQuery{q}
}
...
// Exists checks if the MemberInvite row exists.
func (o *MemberInvite) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return MemberInviteExists(ctx, exec, o.ID)
}
