...
var MemberRebateRecordTableColumns = struct {
	ID               string
	OrderID          string
	ReceiverMemberID string
	Count            string
	...
	ID:               "member_rebate_record.id",
	OrderID:          "member_rebate_record.order_id",
	ReceiverMemberID: "member_rebate_record.receiver_member_id",
	Count:            "member_rebate_record.count",
	CreatedAt:        "member_rebate_record.created_at",
	UpdatedAt:        "member_rebate_record.updated_at",
}
...
var (
	...
	memberRebateRecordGeneratedColumns      = []string{}
)
...
func MemberRebateRecords(mods ...qm.QueryMod) memberRebateRecordQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`member_rebate_record`.*"})
	}

	return memberRebateRecordQuery{q}
}
...
// Exists checks if the MemberRebateRecord row exists.
func (o *MemberRebateRecord) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return MemberRebateRecordExists(ctx, exec, o.ID)
}
