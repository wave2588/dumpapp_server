...
var DispenseCountRecordTableColumns = struct {
	ID        string
	MemberID  string
	Type      string
	ObjectID  string
	...
	ID:        "dispense_count_record.id",
	MemberID:  "dispense_count_record.member_id",
	Type:      "dispense_count_record.type",
	ObjectID:  "dispense_count_record.object_id",
	Count:     "dispense_count_record.count",
	CreatedAt: "dispense_count_record.created_at",
	UpdatedAt: "dispense_count_record.updated_at",
}
...
var (
	...
	dispenseCountRecordGeneratedColumns      = []string{}
)
...
func DispenseCountRecords(mods ...qm.QueryMod) dispenseCountRecordQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`dispense_count_record`.*"})
	}

	return dispenseCountRecordQuery{q}
}
...
// Exists checks if the DispenseCountRecord row exists.
func (o *DispenseCountRecord) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return DispenseCountRecordExists(ctx, exec, o.ID)
}
