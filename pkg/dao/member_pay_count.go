...
// MemberPayCountDAO ...
type MemberPayCountDAO interface {
	Insert(ctx context.Context, data *models.MemberPayCount) error
	Update(ctx context.Context, data *models.MemberPayCount) error
	Delete(ctx context.Context, id int64) error
	Get(ctx context.Context, id int64) (*models.MemberPayCount, error)
	// BatchGet retrieves multiple records by primary key from db.
	BatchGet(ctx context.Context, ids []int64) (map[int64]*models.MemberPayCount, error)
	// 后台和脚本使用：倒序列出所有
